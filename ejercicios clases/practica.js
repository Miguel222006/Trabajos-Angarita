...
const Empleado1= new Empleado("Miguel", 2000);
console.log(Empleado1.trabajar());

console.log(Empleado1.getSalario());
console.log(Empleado1.setSalario(5000));

console.log(persona1.getedad());
console.log(Empleado1.setedad(22));
...
const salario1 = new CuentaBancaria(800);
console.log(salario1.getSaldo());

console.log(salario1.depositar(500));
console.log(salario1.retirar(100));
...
const Vehiculo1 = new Vehiculo("Chevrolet", "Camaro");
Vehiculo1.arrancar();
console.log(Vehiculo1.getvehiculo());


const coche1 = new Coche("Nissan", "Frontier");
coche1.mover();
console.log(coche1.getcoche());


const bicicleta1 = new bicicleta("GW", "MTB 29 Zebra");
bicicleta1.mover();
...
const empleado1 = new Empleado3("Miguel Patiño");
const empleado2 = new Empleado3("Sara Rodrigez");

const vehiculoF = new Vehiculo2("Moto 2000");
const vehiculoA = new Vehiculo2("Carro 5000");
